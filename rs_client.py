...
if __name__ == "__main__":
    ...
    users = discovery_client.get_service_users(user_name='tbilisi', user_password='123456')
...
#     users = discovery.get_service_users(user_name='tbilisi', user_password='123456')
#
#     candidates = [
#         u for u in users
